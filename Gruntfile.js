module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    concat: {
      ...
      build: {
        files: {
          'build/<%= pkg.name %>-bitmovin.js': ['js/core/*.js', 'js/adapters/bitanalytics-bitmovin.js'],
          'build/<%= pkg.name %>-jw.js': ['js/core/*.js', 'js/adapters/bitanalytics-jw.js'],
          'build/<%= pkg.name %>-radiant.js': ['js/core/*.js', 'js/adapters/bitanalytics-radiant.js']
        }
      }
    },
    watch: {
